...
const AmalgamsanierungPage = ({ data }) => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <html lang="de" />
        <title>Amalgamsanierung - Zahnarztpraxis Dr. Sandra Faltermeier</title>
        <meta
          name="description"
          content="Schonende Entfernung giftiges Amalgams aus den Zähnen unter höchster Schutzmaßnahmen."
        />
        ...
        <meta
          property="og:title"
          content="Amalgamsanierung - Zahnarztpraxis Dr. Sandra Faltermeier"
        />
        <meta property="og:url" content="/leistungen/amalgamsanierung" />
        <meta
...
export default AmalgamsanierungPage;

export const query = graphql`
  {
    markdownRemark(
      frontmatter: { templateKey: { eq: "amalgamsanierung-page" } }
    ) {
      frontmatter {
        title
        subtitle
