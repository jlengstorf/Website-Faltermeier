...
const KunststofffüllungenPage = ({ data }) => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <html lang="de" />
        <title>
          Kunststofffüllungen - Zahnarztpraxis Dr. Sandra Faltermeier
        </title>
        <meta
          name="description"
          content="Kunstofffüllungen auch Kompositfüllungen genannt werden mittlerweile standardmäßig in der Füllungstherapie eingesetzt und ersetzen in vielen Fällen die bereits erwähnte Amalgamfüllung. 
        ...
        <meta
          property="og:title"
          content="Kunststofffüllungen - Zahnarztpraxis Dr. Sandra Faltermeier"
        />
        <meta
          ...
          In unserer Praxis verwenden wir mit Admira Fusion ein rein keramisch basiertes Füllungsmaterial der Firma Voco."
        />
        <meta property="og:url" content="/leistungen/kunststofffüllungen" />
      </Helmet>
      <Layout>
...
export default KunststofffüllungenPage;

export const query = graphql`
  {
    markdownRemark(
      frontmatter: { templateKey: { eq: "kunststofffüllungen-page" } }
    ) {
      frontmatter {
        title
        subtitle
