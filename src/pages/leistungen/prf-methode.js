...
const PrfPage = ({ data }) => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <html lang="de" />
        <title>PRF Methode - Zahnarztpraxis Dr. Sandra Faltermeier</title>
        <meta
          name="description"
          content="PRF steht für Platelet Rich Fibrin und ist ein wichtiger Bestandteil des Blutes. Denn ohne unseren Klebstoff Fibrin wäre an eine körpereigene Wundheilung nicht zu denken. Genau hier setzt das PRF Verfahren an."
        />
        ...
        <meta
          property="og:title"
          content="PRF Methode - Zahnarztpraxis Dr. Sandra Faltermeier"
        />
        <meta
          property="og:description"
          content="PRF steht für Platelet Rich Fibrin und ist ein wichtiger Bestandteil des Blutes. Denn ohne unseren Klebstoff Fibrin wäre an eine körpereigene Wundheilung nicht zu denken. Genau hier setzt das PRF Verfahren an."
        />
        <meta property="og:url" content="/leistungen/prf-methode" />
      </Helmet>
      <Layout>
...
export default PrfPage;

export const query = graphql`
  {
    markdownRemark(frontmatter: { templateKey: { eq: "prf-page" } }) {
      frontmatter {
        title
        subtitle
        imageObject {
